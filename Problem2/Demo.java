...
public class Demo {
    public static void main(String[] args) {
        try {
            ...
            movable1.setXSpeed(3.0f);
            movable1.setYSpeed(-3.0f);
            ...
            MovablePoint movable3 = new MovablePoint(2.0f, 1.0f, 2.0f, 4.0f);
